...
function a(){this.files={},this.getCompilationSettings=ts.getDefaultCompilerOptions,this.getScriptIsOpen=function(){return!0},this.getCurrentDirectory=function(){"./"},this.getDefaultLibFileName=function(a){return"lib.d.ts"}}return a.prototype.log=function(a){console.log("log",a)},a.prototype.trace=function(a){console.log("trace",a)},a.prototype.error=function(a){console.log("error",a)},a.prototype.getScriptVersion=function(a){return this.files[a]?this.files[a].ver.toString():null},a.prototype.getScriptSnapshot=function(a){return this.files[a].file},a.prototype.getScriptFileNames=function(){var a=[];for(var b in this.files)this.files.hasOwnProperty(b)&&a.push(b);return a},a.prototype.addFile=function(a,b){var c=ts.ScriptSnapshot.fromString(b);c.getChangeRange=function(a){return void 0};var d=this.files[a];d?(this.files[a].ver++,this.files[a].file=c):this.files[a]={ver:1,file:c}},a}(),f=document.getElementsByTagName("script"),g=document.getElementsByTagName("body")[0],h=[];for(b=0;b<f.length;b++)"text/typescript"==f[b].type&&h.push(f[b].src?{filename:f[b].getAttribute("src"),data:load(f[b].src)}:{filename:"inline."+b+".ts",data:f[b].innerHTML});var i=new e,j=ts.createLanguageService(i,ts.createDocumentRegistry()),k={};i.addFile("lib.d.ts",d);var l;for(l=0;l<h.length;l++)null!==h[l].filename&&i.addFile(h[l].filename,h[l].data);for(l=0;l<h.length;l++)if(null!==h[l].filename){var m=j.getEmitOutput(h[l].filename),n=a(h[l].filename);n.length>0&&(k[h[l].filename]=n),h[l].compiled=m.outputFiles[0].text,c=document.createElement("script"),c.type="text/javascript",c.innerHTML="//Compiled TypeScript\n\n"+h[l].compiled,g.appendChild(c)}},compile()}();